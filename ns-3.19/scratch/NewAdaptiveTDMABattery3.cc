...
#include "ns3/nano-sensor-battery.h"
 ...
 NS_LOG_COMPONENT_DEFINE ("NewAdaptiveTDMABattery3");
...
/* function that sets up all the nanonetwork node scenario and sends packet in Adaptive TDMA manner*/
void runAdaptiveTDMA(Ptr<Riskcalculator> riskc)
{
...
{	
	...
	std::cout<<"Slots miss rate : "<<slotmissrate<<"%"<<std::endl;	
	...
	resultsfile.open("Results-AdaptiveTDMABattery2.txt", std::ofstream::out | std::ofstream::app);
